...
public class PotvrdiEntitet2 implements ActionListener {
	...
	public PotvrdiEntitet2(JTextArea ta, JDialog dialog, Entitet entitet, Paket paket) {
		this.ta = ta;
		this.dialog = dialog;
