...
import controller.UpdateIzaberiEntitetAkcija;
import modeli.Entitet;
import modeli.InformacioniResurs;
import modeli.Paket;

public class UpdateIzaberiEntitet extends JDialog {

	private JList<Entitet> lista;
	private DefaultListModel<Entitet> model;
	
	public UpdateIzaberiEntitet() {
		model = new DefaultListModel<>();
		lista = new JList<>(model);
		setTitle("Izaberite entitet");
		setSize(300, 300);
		...
		dugme.addActionListener(new UpdateIzaberiEntitetAkcija(this));
