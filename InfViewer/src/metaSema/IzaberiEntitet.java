...
public class IzaberiEntitet extends JDialog {

	private JList<Entitet> lista;
	private DefaultListModel<Entitet> model;
	
	public IzaberiEntitet() {
		model = new DefaultListModel<>();
		lista = new JList<>(model);
		setTitle("Izaberite entitet na koji se dodaje");
		setSize(300, 300);
		...
		dugme.addActionListener(new IzaberiEntitetAkcija(this));
