...
import controller.IzaberiEntitetRelacija2;
import modeli.Entitet;
import modeli.InformacioniResurs;
import modeli.Paket;

public class IzaberiEntitet3 extends JDialog {

	private JList<Entitet> lista;
	private DefaultListModel<Entitet> model;
	
	public IzaberiEntitet3(Entitet entitet) {
		model = new DefaultListModel<>();
		lista = new JList<>(model);
		setTitle("Izaberite drugi entitet");
		setSize(300, 300);
		...
		dugme.addActionListener(new IzaberiEntitetRelacija2(this, entitet));
