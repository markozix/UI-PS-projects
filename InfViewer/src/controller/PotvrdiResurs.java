...
public class PotvrdiResurs implements ActionListener {

	private JDialog dialog;
	private JTextArea ta;
	
	public PotvrdiResurs(JTextArea ta, JDialog dialog) {
		this.ta = ta;
		this.dialog = dialog;
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		EditorMetaSeme.getInstance().getResurs().setNaziv(subString);
